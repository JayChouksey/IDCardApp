...
public class PrintedStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(role.equals("Student")){
            heading.setText("Printed Student Data");
            fetchStudentData();
        }
        else if(role.equals("Staff")){
            heading.setText("Printed Staff Data");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null,
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.networkResponse != null && error.networkResponse.data != null) {
                    ...
                    Toast.makeText(PrintedStudent.this, "Error showing student data", Toast.LENGTH_SHORT).show();
                }
            }
        }) {
            @Override
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, null,
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.networkResponse != null && error.networkResponse.data != null) {
                    ...
                    Toast.makeText(PrintedStudent.this, "Error showing staff data", Toast.LENGTH_SHORT).show();
                }
            }
        }) {
            @Override
